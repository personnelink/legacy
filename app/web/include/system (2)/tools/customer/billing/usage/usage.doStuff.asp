<!-- #include file='usage.classes.asp' -->
...
case "history"
	CustomerUsage.Report = "history"
	report_title = "Usage History"
	CustomerUsage.LoadHistoryActivity
case else
	CustomerUsage.Report = "current"
	report_title = "Current Usage"
	CustomerUsage.LoadCurrentActivity
end select
