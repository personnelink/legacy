...
session("add_css") = "timecardform.asp.dev.css"
...
<div id="getLastFour">
   <form action="timecardEmp.asp" method="post" name="getEmp" id="getEmp" on="document.getEmp.formAction.value='continue'">
 ...
 <input name="ssn4" id="ssn4" type="text" maxlength="4" Value="<%=request.form("ssn4")%>" /></p>
  ...
  <p> <a class="squarebutton" href="#" onclick="document.getEmp.formAction.value='continue';document.getEmp.()"><span>Continue</span></a> </p>
  </form>
</div>
<%
...
<%
	...
	placements.Open "GET", "http://192.168.0.2/include/system/tools/timecards/getPlacements.asp?empcode=" & user_empcode & "&status=0&isint=" & isInternal, false
	placements.Send
	...
	timecards.Open "GET", "http://192.168.0.2/include/system/tools/timecards/getSavedTime.asp?id=" & user_id, false
	timecards.Send
	...
	if Not checkIfApprover.eof then
		...
		weekending.Open "GET", "http://192.168.0.2/include/system/tools/timecards/getCompanySavedTime.asp?id=" & companyId, false
		weekending.Send
...
<form id="form1" name="form1" method="post" action="">
    ...
    <p> PLEASE NOTE: Company policy requires approval for all work hours and that all over-time house require prior approval. All hours not approved will not be paid.</p>
	</div>
  ...
  <div class="dayOfTheWeek">
    <ul>
      ...
      <li>Time-In</li>
      <li>Time-Out</li>
      <li class="tally">Reg</li>
      <li class="tally">OT</li>
      <li class="tally">Sick</li>
      <li class="tally">Hol</li>
      <li class="tally">Vaca</li>
      <li class="tally">Comp</li>
  ...
  <div class="dayOfTheWeek">
    <ul>
      ...
      <li class="tally totalhours"><span>0</span></li>
      <li class="tally totalhours"><span>0</span></li>
      <li class="tally totalhours"><span>0</span></li>
      <li class="tally totalhours"><span>0</span></li>
    </ul>
