...
<form id="viewActivityForm" name="viewActivityForm" action="../../../tools/timecards/viewApplications.asp" method="get" />
 ...
 <a class="squarebutton" href="#" style="float:none" onclick="avascript:document.viewActivityForm.submit();"><span style="text-align:center"> Search </span></a>
  ...
  <%
	...
	'if len(whichCompany & "") > 0 then
		...
		response.write "<A HREF=""/include/system/tools/activity/applications/view/?Page=1&" & rsQuery & """>First</A>"
		For i = 1 to nPageCount
			response.write "<A HREF=""/include/system/tools/activity/applications/view/?Page="& i & "&" & rsQuery & """>&nbsp;"
			if i = nPage then
			...
			response.write "&nbsp;</A>"
		Next
		response.write "<A HREF=""/include/system/tools/activity/applications/view/?Page=" & nPageCount & "&" & rsQuery & """>Last</A>"
		response.write("</div>")
		...
		Response.write "<div id='appResults'><table class='onlineApps'><tr>" &_
			"<th class='appCompanies' colspan='4'>Entroll Into</th>" &_
...
End if 
response.write("<div id=""topPageRecords"" class=""navPageRecords"">")
response.write "<A HREF=""/include/system/tools/activity/applications/view/?Page=1"">First</A>"
	For i = 1 to nPageCount
		response.write "<A HREF=""/include/system/tools/activity/applications/view/?Page="& i & """>&nbsp;"
		if i = nPage then
			response.write "<span style=""color:red"">" & i & "</span>"
		Else
			response.write i
		...
		response.write "&nbsp;</A>"
	Next
response.write "<A HREF=""/include/system/tools/activity/applications/view/?Page=" & nPageCount & """>Last</A>"
