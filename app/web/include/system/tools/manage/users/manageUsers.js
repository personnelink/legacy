...
function getApplicantIDs() {
	...
	var user = {
	    update: function () {
	        var btnValue = document.getElementById('btnUserValue').innerHTML			
	        switch (btnValue) {
	            case "Add":
	                document.manageUsersForm.formAction.value = 'create';
					break;
	            case "Update":
	                document.manageUsersForm.formAction.value = 'update';
					break;
	        }
	        document.manageUsersForm.submit();
	    },
	    remove: function (userid) {
            document.manageUsersForm.formAction.value = 'remove';
	        // document.manageUsersForm.submit();
	    }
	}
