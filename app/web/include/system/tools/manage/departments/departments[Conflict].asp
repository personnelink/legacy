<%
session("add_css") = "./departments.css" 
session("window_page_title") = "Manage Departments - Personnel Plus"
%>
<!-- #INCLUDE VIRTUAL='/include/core/init_secure_session.asp' -->
<!-- #INCLUDE file='departments.doStuff.asp' -->
...
Sub ShowDepartments
	...
	dLink = "<a href='/include/system/tools/departments.asp?Action=" & view & "&amp;DepartmentID="
	DepartmentID = 0
	Display = 1
	Database.Open MySql
...
<a class="squarebutton" href="javascript:;" style="margin-left: 6px" onclick="document.forms['manageDepartments'].submit();"><span>Delete Selected</span></a> <a class="squarebutton" href="javascript:;" onclick="document.forms['manageDepartments'].submit();"><span>Add Department</span></a>
    </form>
<%=DecorateBottom()%>	
<%
	Set dbQuery = Nothing
