...
public function doAddTimedetail()
	...
	if not rs.eof then
		...
		dim strResponse
		strResponse = "<table id=""timedetail" & detailid & """ class=""time_detail detailentry"">" &_
			"<tr>" &_
				...
				"<td class=""timeinput"">" &_	 
					"<input class=""cid" & TimeDetail.CreatorId & " sid" & user_id & """ id=""out_" & rowid & """ name=""detailRow_" & rowid & """ " &_
						"onchange=""timeclock.setTime(this.id)"" value="""""">" &_
				"</td>" &_
				"<td class=""hoursactual"">" &_
					"<input id=""actual_" & rowid & """ name=""detailRow_" & rowid & """ " &_
...
public function doTimedetail()
	...
	dim strResponse
		strResponse = "<table class=""time_detail"" id=""plcemntTbl_" & TimeDetail.PlacementId & "_" & TimeDetail.SummaryId & """>" &_
					"<tr>" &_
						"<th><div style=""width:1em;"" class=""left_margin"">&nbsp;</div></th>" &_
						"<th class=""weekday"">Weekday</th>" &_
						"<th class=""timeinput"">Time-In</th>" &_
						"<th class=""timeinput"">Time-Out</th>" &_
						"<th class=""timeinput"">Actual</th>" &_
						"<th class=""timeinput"">Adjusted</th>" &_
						"<th class=""timeinput"">Total</th>" &_
						"<th>Time Type</th>" &_
			...
			do until rs.eof
				...
				strResponse = strResponse &_
					"<table id=""timedetail" & TimeDetail.DetailId & """ class=""time_detail detailentry"">" &_
						"<tr>" &_
							"<td class=""left_margin"">&nbsp;</td>" &_
							"<td class=""weekday"">" &_
								objDaySelect(TimeDetail.Workday, rowid, TimeDetail.CreatorId) &_
							...
							"</td>" &_
							"<td class=""hoursactual"">" &_
								"<input readonly=""true"" id=""actual_" & rowid & """ name=""detailRow_" & rowid & """ " &_
