	...
	for each Summary in SumOfHours.Items
		if Summary.id > 0 then
			...
			<table class="time_summary cid<%=Summary.creatorid%>">
				...
				<table class="time_summary" id="time_summary_<%=placementid & "_" & Summary.id%>">
				<tr>
					...
					<td class="col_day"><span class="daysum cid<%=Summary.creatorid%> sid<%=user_id%>" id="sum_d<%=lcase(Summary.DayName(0))%>_<%=placementid%>_<%=Summary.id%>" name="sum_d<%=lcase(Summary.DayName(0))%>_<%=placementid%>_<%=Summary.id%>" size="2"><%=Summary.Day(1)%></span></td>
					<td class="col_day"><span class="daysum cid<%=Summary.creatorid%> sid<%=user_id%>"  id="sum_d<%=lcase(Summary.DayName(1))%>_<%=placementid%>_<%=Summary.id%>" name="sum_d<%=lcase(Summary.DayName(1))%>_<%=placementid%>_<%=Summary.id%>" size="2"><%=Summary.Day(2)%></span></td>
					<td class="col_day"><span class="daysum cid<%=Summary.creatorid%> sid<%=user_id%>"  id="sum_d<%=lcase(Summary.DayName(2))%>_<%=placementid%>_<%=Summary.id%>" name="sum_d<%=lcase(Summary.DayName(2))%>_<%=placementid%>_<%=Summary.id%>" size="2"><%=Summary.Day(3)%></span></td>
					<td class="col_day"><span class="daysum cid<%=Summary.creatorid%> sid<%=user_id%>"  id="sum_d<%=lcase(Summary.DayName(3))%>_<%=placementid%>_<%=Summary.id%>" name="sum_d<%=lcase(Summary.DayName(3))%>_<%=placementid%>_<%=Summary.id%>" size="2"><%=Summary.Day(4)%></span></td>
					<td class="col_day"><span class="daysum cid<%=Summary.creatorid%> sid<%=user_id%>"  id="sum_d<%=lcase(Summary.DayName(4))%>_<%=placementid%>_<%=Summary.id%>" name="sum_d<%=lcase(Summary.DayName(4))%>_<%=placementid%>_<%=Summary.id%>" size="2"><%=Summary.Day(5)%></span></td>
					<td class="col_day"><span class="daysum cid<%=Summary.creatorid%> sid<%=user_id%>"  id="sum_d<%=lcase(Summary.DayName(5))%>_<%=placementid%>_<%=Summary.id%>" name="sum_d<%=lcase(Summary.DayName(5))%>_<%=placementid%>_<%=Summary.id%>" size="2"><%=Summary.Day(6)%></span></td>
					<td class="col_day"><span class="daysum cid<%=Summary.creatorid%> sid<%=user_id%>"  id="sum_d<%=lcase(Summary.DayName(6))%>_<%=placementid%>_<%=Summary.id%>" name="sum_d<%=lcase(Summary.DayName(6))%>_<%=placementid%>_<%=Summary.id%>" size="2"><%=Summary.Day(7)%></span></td>
					<td class="col_spc">&nbsp;=&nbsp;</td>		
					<td class="col_day"><span class="cid<%=Summary.creatorid%> sid<%=user_id%>" id="sum_rt_<%=placementid%>_<%=Summary.id%>" name="sum_rt_<%=placementid%>_<%=Summary.id%>" size="2"><%=Summary.TotalHours%></span></td>
					<td class="col_spc">+</td>		
