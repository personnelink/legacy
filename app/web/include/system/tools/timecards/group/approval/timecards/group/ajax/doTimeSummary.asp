	...
	with cmd
		...
		if isnumeric(g_strSite) then
			.CommandText = "" &_
				...
				"(placementid, customer, site, weekending, createdby) " &_
				"VALUES " &_
				"(" & placementid & ", " & insert_string(customer) & ", " & g_strSite & ", " & insert_string(p_weekending) & ", 'H')"
		else
			.CommandText = "" &_
				"INSERT INTO time_summary " &_
				"(placementid, customer, site, weekending, createdby) " &_
				"VALUES " &_
				"(" & placementid & ", " & insert_string(customer) & ", " & getSiteNumber(g_strSite) & ", " & insert_string(p_weekending) & ", 'H')"
		end if
