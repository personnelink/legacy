...
var getInvoice = {
    ...
    close: function (row_number, inv_number, site, cust) {
        ...
        if (objDetailLine.getAttribute("className") !== null) { //ie stuff
...
var look_up_inv = function (row_number, inv_number, site, cust) {
    ...
    var PostStr = "inv=" + inv_number + "&" + site + cust + "&row=" + row_number;
...
var payment = {
    ...
    hide: function () {
        ...
        document.getElementById("make_payment").style.display = 'hidden';
    },
