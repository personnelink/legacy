...
session("window_page_title") = "Current Ledger - Personnel Plus"
%>
...
%>
<%=decorateTop("AccountActivity", "notToShort marLR10", "Current Ledger and Account Activity")%>



<form id="viewActivityForm" name="viewActivityForm" method="post" class="left">
...
<%
	if company_dsn_site > -1 or simsite <> "" then
		...
		if len(thisConnection) > 0 then 
            ...
            <table id="paymentOptions">
                <tr class="hide">
                	<td id="paymentoptions" colspan="4">Payment Options<ul><li id="achopt">&nbsp;</li><li id="paypalopt"></ul></td>
								</tr>                <tr>
	...
	<span>
	<a href="/include/system/tools/activity/reports/usage/" style="color:#fff">History Ledger</a>
	</span>
	</span>	
