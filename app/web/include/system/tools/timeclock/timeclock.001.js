...
var serverTime = {
	update: function() {
		...
		doAJAXCall('/include/system/tools/timeclock/ajax/server.time.asp', 'HEAD', '' + PostStr + '', serverTime.calcOffset);
	},
...
var user_info = {
	...
	update: function (oXML) {
		...
		doAJAXCall('/include/system/tools/timeclock/ajax/', 'GET', '' + GetStr + '', cost_centers.update);
...
var cost_centers = {
	...
	get_actions: function(placementid, applicantid, siteid, customer){
		...
		doAJAXCall('/include/system/tools/timeclock/ajax/', 'GET', '' + GetStr + '', timeclock.show_actions);
	},
