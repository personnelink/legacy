...
%>
        <form enctype="multipart/form-data" method="post" id="form1" name="form1" action="/include/system/tools/emailResume.asp?func=2">
		  ...
		  <p>
	   		  <button onclick="window.open('/include/system/tools/activity/forms/uploadFile.asp', 'Attach File', 'height=140px,width=400px,modal=yes,alwaysRaised=yes');">Attach</button>
          </p>
          <p>
...
'loop
	...
	msgBody = "A Resume from " & resumeCity & ", " & resumeState & " " & resumeZip &_
		" was submitted " & now() & chr(10) & chr(10) &_
		"Resumes are delivered to the 'Received' folder located here: \\personnelplus.net.\net_docs\resumes " & chr(10) & chr(10) &_
		"The resumes can be searched using the online Resume Search tool or " &_
		"your operating systems built in search tool." & chr(10)
