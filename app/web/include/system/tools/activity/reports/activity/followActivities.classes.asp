...
public property let CustomerType(p_CustomerType)
	m_CustomerType = p_CustomerType
end property

public property get CustomerClass()
	CustomerClass = m_CustomerClass
end property
public property let CustomerName(p_CustomerClass)
	m_CustomerClass = p_CustomerClass
end property
...
'#############  Public Functions ##############
	...
	public function GetAllPlacements()
		...
		strSQL = "SELECT Appointments.Id, Appointments.AppDate, Appointments.Reference, Appointments.Customer, Appointments.Comment, " &_
				...
				"Customers.CustomerType, Customers.TermsCode AS CustomerClass, " &_
...
'#############  Private Functions ##############
    ...
    private function FillPlacementsFromRS(p_RS)
        ...
        do while not ( p_RS.eof Or p_RS.AbsolutePage <> m_Page )
            ...
            thisAppointment.CustomerType      = p_RS.fields("CustomerType").Value
            thisAppointment.CustomerClass     = p_RS.fields("CustomerClass").Value
