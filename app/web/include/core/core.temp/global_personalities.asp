...
elseif instr(http_host, right(sandboxURL, len(sandboxURL)-9)) > 0  then 'next.personnelinc.com expression
...
elseif instr(http_host, right(nextURL, len(nextURL)-9)) > 0  then 'sandbox.personnelinc.com expression
