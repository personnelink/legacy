<!-- #INCLUDE VIRTUAL='include/core/global_classes.vb' -->
<%
class cCustomerCode
	private m_CustomerCode
	private m_NumOfCompanies
	private m_SqlWhereString
	private m_SqlWhereAttribute
	private m_CustomerCodeArray
	...
	public property get NumOfCompanies()
	...
	public property get SqlWhereString()
		...
		for each p_CustomerCode in p_CustomerCodes
			Sql = Sql & m_SqlWhereAttribute & "='" & trim(p_CustomerCode) & "' OR "
		next
		if len(Sql) > 0 then
	...
	public property get SqlWhereAttribute()
		SqlWhereAttribute = m_SqlWhereAttribute
	end property
	public property let SqlWhereAttribute(p_SqlWhereAttribute)
		m_SqlWhereAttribute = p_SqlWhereAttribute
	end property

	public property get CustomerCodeArray()
		CustomerCodeArray = Split(m_CustomerCode, ",")
		print "m_CustomerCode: " & m_CustomerCode
