...
session("window_page_title") = "Contact Us - Personnel Plus"
 %>
...
Database.Open MySql
Set content = Database.Execute("Select * From tbl_content Where class='contacts' Order By classindex")
do while not content.eof 
	...
	if thisUsersSecurityLevel => userLevelPPlusSupervisor then
		manageThisBlog = true
		contentTasks = "<a style='float:right; clear: none;' href=" & Chr(34) & "/include/system/tools/edit/?blogid=" & contentID & Chr(34) &_
