...
If formAction = "send" Then
	...
	if Err.Number = 0 then
		Call SendEmail (deliveryLocation, notify_managers_email, msgSubject, msgBody, "")
	else
		Call SendEmail ("debug@personnel.com", notify_managers_email, "Debug: " & Err.Number & " : " & msgSubject, msgBody, "")
	end if
...
leftSideMenu = "" &_
	"<div class=""notes"">" &_
      "<h4> Candidates! </h4>" &_
      "<p class=""last"">As a full-service provider of employment and staffing solutions, we're not just a staffing agency, we're a provider of intelligent employment solutions that companies all over the gem state and individuals alike can utilize to help manage your staffing and job recruitment requirements. And as the economic tides eb and everyone alike is affected we can provide a layer of flexibilty otherwise not possible. We  help by optimizing business cycles and with staff augmentation, contingency planning, project deadlines, and immediate direct placements.</p>" &_
    "</div>" &_
	"<div class=""notes"">" &_
      "<h4> Integrity </h4>" &_
      "<p class=""last"">Our solid integrity and numerous opportunities for temporary, temporary-to-hire, contract and direct hire positions attract a steady flow of candidates. Our advanced recruiting program allows us to extend  from a nation wide talent pool access to a highly qualified and diverse group of people to find exactly the right candidates.</p>" &_
    "</div>"
...
%>
  ...
  <div id="employmentopportunity">
    <div  class="notes" id="instructions" style="float:right;width:24em;margin:2em 3em"><p>Use this to submit work requests.</p><p>Once submitted, a work order will be dispatched to the nearest branch office for processing.</p>
