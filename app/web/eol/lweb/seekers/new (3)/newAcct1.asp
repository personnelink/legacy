...
<TD BGCOLOR="#003366" HEIGHT="35" ALIGN="right" NOWRAP><FONT COLOR="#FFFFFF">Creating Your New Account - STEP <STRONG>1</STRONG> of 4</FONT><IMG SRC="/lweb/img/tab_top_right.gif" ALT="" WIDTH="17" HEIGHT="35" BORDER="0" ALIGN="absmiddle"></TD>
				</TR>
				<TR>
				<TD COLSPAN="2">
...
<% if session("auth") = "true" then %>
					<TR>
						<TD colspan="2" align="center">You are currently logged in. While you are welcome to create multiple accounts, you must <A HREF="/lweb/logout.asp">Log Out</A> from your current account before creating a new one.</TD>
					</TR>
					</TABLE>
				</TD>
				</TR>
...
<% end if %>						
				...
				<A HREF="/lweb/hlp/hlp_rememberMe.asp" onClick="NewWindow(this.href,'helpWin','300','300','yes','center');return false" onFocus="this.blur()"><FONT SIZE="1">What's This?</FONT></A>
					...
					<form method="POST" action="/lweb/index2.asp?who=2&?#applicant">
