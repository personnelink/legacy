...
dim emailToAddress		:		emailToAddress = request("officeSelector")
...
if request("officeSelector") = "other" then
	...
	response.cookies("applyDirect")("emailToAddress") = "twin@personnel.com"
else
	response.cookies("applyDirect")("emailToAddress") = request("officeSelector")
end if
...
response.redirect"/lweb/seekers/new/emailresume/upload2.asp"
%>