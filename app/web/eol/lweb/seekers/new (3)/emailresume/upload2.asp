...
<TABLE WIDTH=80% BORDER=0 CELLPADDING=0 CELLSPACING=0 bgcolor="#f5f5dc">  
	 ...
	 <tr>
		<td align="center" style="border:1px solid #333333;">
    		<FORM ENCTYPE="multipart/form-data" METHOD=post id=form1 name=form1 action="/lweb/seekers/new/emailresume/upload2.asp?func=2">
    			<br><br>
...
do while lngCurrentEnd > 0
			...
			FileName = request.cookies("applyDirect")("lastName") & ", " & request.cookies("applyDirect")("firstName") & "." & Right(FileName,(len(FileName)-Instr(Len(FileName)-6, FileName, ".")))
    		...
    		lngDataLenth = lngEndPos - lngBeginPos
				...
				'FileName = request.cookies("applyDirect")("lastName") & ", " & request.cookies("applyDirect")("firstName")
    			Set fso = CreateObject("Scripting.FileSystemObject")
    				Set f = fso.OpenTextFile(server.mappath("/lweb/seekers/new/emailresume/uploads") & "\" & FileName, ForWriting, True)
    					f.Write strFileData
    
						' Get full Path, you need it for deleting the file later  	
    					Dim ThisFile
    				ThisFile = server.MapPath("/lweb/seekers/new/emailresume/uploads") & "/" & filename
...
' ========================
	...
	response.redirect"/lweb/seekers/new/emailresume/upload2.asp?func=3"        		
...
<% end if %>
<p></p>
Feel free to contact your local Personnel Plus <a href="/lweb/company/offices.asp"><strong>Office</strong></a> if you have any additional questions.
<p></p>
