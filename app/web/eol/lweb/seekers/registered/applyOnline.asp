...
<title><%=session("lastName")%>, <%=session("firstName")%>  - Online Resume - Personnel Plus, Inc.</title>
...
<TABLE WIDTH=75% BORDER=0 CELLPADDING=0 CELLSPACING=4 bgcolor="#dcbace">  
  <tr>
  	<td width="100%" align="center" colspan="2" bgcolor="#dcbace"><a href="/lweb/seekers/registered/emailresume/upload.asp"><strong>Upload an Existing Resume</strong></a>
  	</td>
  </tr>
  <tr>
  	<td><center>or</center>
...
<input type="hidden" name="title" value="<%=session("lastName")%>,  <%=session("firstName")%> - online resume">
		<table width="100%" border="0" cellspacing="2" cellpadding="4" bgcolor="#FFFFFF">	
		<TR>
			<TD align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="2">
				<tr>
					<td bgcolor="#C7D2E0"><font size="+1"><%=session("firstName")%>&nbsp;<%=session("lastName")%></font></td>
				</tr>
				<tr>
...
<% end if %>				
				...
				<tr>
					<td><%=session("city")%>, <%=session("state")%>&nbsp;<%=session("zipCode")%></td>
				</tr>
				<tr>
