...
<div align="center">
	<table border="0" width="660">
		...
		<tr>
			<td align="center" width="654">
				<div style="position: absolute; width: 100px; height: 23px; z-index: 1; left: 396px; top: 99px" id="layer1">
					<FORM> 
				...
				<H3>Greyback Forestry</H3>
				<p>
					<img src="/lweb/img/GreyBackForestry.JPG" width="750">
				</p>
			</td>
	</table>
</div>
