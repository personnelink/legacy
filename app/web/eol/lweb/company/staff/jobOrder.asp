...
rsAdminData.Open "SELECT * FROM tbl_admin WHERE userName = '" & session("userName") & "'", Connect, 3, 3
...
<script language="javascript" src="/lweb/inc/popcalendar.js"></script>
...
<TABLE width="55%" border="0" cellpadding="4" cellspacing="5">
	<TR>
		...
		<td style class="smallTxt" align="center" width="50%"><a href="/lweb/company/staff/jobMod.asp"><strong>Edit Job(s) </strong></a></td>
	</TR>
</TABLE>
		...
		<TD width="100%" align="center">
			<TABLE BORDER=0 width="100%" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
				...
				<TR>
					...
					<!--  -->
						<TR>
								<TD COLSPAN="2" ALIGN="center" STYLE CLASS="smallTxt"><IMG SRC="/lweb/img/asterisk.gif" ALT="" WIDTH="7" HEIGHT="9" BORDER="0"> <STRONG>Job Description / Duties:</STRONG></TD>
								</TR>
								<TR>
					...
					<INPUT TYPE="hidden" NAME="companyUserName" SIZE="35" MAXLENGTH="175" VALUE="<%=rsAdminData("userName")%>" TABINDEX="4">
								<TR>
								<TD ALIGN="right" STYLE CLASS="smallTxt"><IMG SRC="/lweb/img/asterisk.gif" ALT="" WIDTH="7" HEIGHT="9" BORDER="0"> Job Title: 		</TD>
						...
						//-->
								...
								<TR>
							<TD ALIGN="RIGHT" STYLE CLASS="smallTxt"><IMG SRC="/lweb/img/asterisk.gif" ALT="" WIDTH="7" HEIGHT="9" BORDER="0"> Wage Amount & Type:<BR><FONT SIZE="1"><EM>(ex. 8.25, 26K-28K, DOE)</EM></FONT></TD>
