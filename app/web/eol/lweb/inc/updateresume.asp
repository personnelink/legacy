...
dim firstName					: firstName=session("firstName")
dim lastName					: lastName=session("lastName")
...
dim zipCode						: zipCode=session("zipCode")
dim contactPhone				: contactPhone=session("contactPhone")
dim emailAddress				: emailAddress=session("emailAddress")
dim title						: title="Resume Emailed to Personnel Plus ask for: " & session("firstName") & " " & session("lastName") & " resume."
...
dim additionalInfo   			: additionalInfo="Resume Emailed to Personnel Plus ask for: " & session("firstName") & " " & session("lastName") & " resume."
