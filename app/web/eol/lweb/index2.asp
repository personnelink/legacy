...
<% if request("who") = 1 then %>
		<tr>
			...
			<img border="0" src="/lweb/img/commu006.jpg" width="150" height="180"></td>
			<td align="center" width="376" height="35">
								...
								<% If session("companyUserName") <> "" Then %>
									...
									<TR>
										<td align="center"><A HREF="/lweb/employers/registered/index.asp?who=1"><strong>Go To Account</strong></a></td>
									</TR>
								<% end if %>		
								<% If session("companyUserName") = "" Then %>	
								<TR>
			...
			<TR>
				...
				<A HREF="/lweb/employers/new/newEmpAcct1.asp?who=1"><STRONG>
				Create your <EM>free</EM> account now and post your job 
				openings!</STRONG></A> 
<FORM NAME="empLogin" METHOD="post" ACTION="/lweb/employers/registered/setSession.asp?who=1">
...
<% End If %>
<BR>
<A HREF="/lweb/employers/forgotLogin.asp?who=1"><FONT SIZE="1"><STRONG>
					Forgot your login?</STRONG></FONT></A><br><br><a href="/lweb/company/qag.asp" target="_blank">View our Quality Assurance Guarantee</a><br>
					<a href="/lweb/company/ppa.asp" target="_blank">See the Personnel Plus Advantage!</a><br>
					<a href="/lweb/company/benefits.asp" target="_blank">Your Benefits Through Us</a><br>
					<a href="/lweb/company/testimonial.asp" target="_blank">Read other Employer's Testimonials</a><br>
					<a href="/lweb/company/hr.asp" target="_blank">Our Human Rescource Services</a><br>
					<a href="/lweb/company/note.asp" target="_blank">A Personal Note From our President...</a>
						</TD>
					</TR>
				</TABLE>
				</FORM>
...
<% if request("who") = 2 then %>
		<tr>
			...
			<img border="0" src="/lweb/img/commu008.jpg" width="150" height="180"></td>
	...
	<!-- id=applicant -->							<TABLE border="0" cellpadding="3" cellspacing="0" width="376">
								<% If session("UserName") <> "" Then %>
									...
									<TR>
										<td align="center"><A HREF="/lweb/seekers/registered/index.asp?who=2"><strong>Go To Account</strong></a></td>
									</TR>
								<% end if %>		
								<% If session("UserName") = "" Then %>
								<TR>
			...
			<TR>
				...
				<A HREF="/lweb/seekers/new/applyDirect.asp?who=2"><STRONG>
				Create your <EM>free</EM> account now and view our job 
				openings!</STRONG></A> 
<FORM NAME="hpform" METHOD="post" ACTION="/lweb/seekers/registered/setSession.asp?who=2">
	<INPUT TYPE="hidden" NAME="pgOrig" VALUE="hp">
				<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0">
					<TR>
...
<% End If %>
<BR>
<A HREF="/lweb/seekers/forgotLogin.asp?who=2"><FONT SIZE="1"><STRONG>
		...
		<tr>
			<td width="450" height="238" colspan="2" align="right" valign="top">
				<TABLE WIDTH="75%" BORDER="0" CELLPADDING="2" CELLSPACING="5" BGCOLOR="#FFFFFF" STYLE="border: 1px solid #000000;">
					<tr>
						<td align=center width="118%" colspan="2"><FONT COLOR="#003366"><strong>Welcome,  <%=session("firstName")%>&nbsp;<%=session("lastName")%></strong></FONT></td>
					</tr>
					<TR>
					...
					<TR>
						<TD STYLE CLASS="smallTxt" ALIGN="center" width="52%"><A HREF="/lweb/company/staff/jobOrder.asp"><STRONG>Post a New Job</STRONG></A> 			</TD>
						<TD STYLE CLASS="smallTxt" ALIGN="center" width="42%"><A HREF="/lweb/company/staff/jobMod.asp"><STRONG>Edit Job(s) </STRONG></A> 			</TD>
					</TR>
					<TR>
						<TD COLSPAN="2" ALIGN="center" CLASS="smallTxt">
							<A HREF="/lweb/company/staff/jpm_admguide.asp" TARGET="_NEW"><STRONG>Overview & Instructions </STRONG></A>
						</TD>
					</TR>	
				</TABLE>
			</td>
...
<IMG SRC="/lweb/img/shake.jpg" ALT="" WIDTH="150" HEIGHT="85" BORDER="0" ALIGN="left" hspace="0"></td>
		...
		<tr>
			...
			<td width="376" align="center" height="48">
				<a href="http://www.staffingtoday.net/aboutasa/index.html" target="_blank">
					<img src="/lweb/img/asa.gif" alt="" width="264" height="48" border="0">
				</a>
			</td>
		</tr>
	</table>
