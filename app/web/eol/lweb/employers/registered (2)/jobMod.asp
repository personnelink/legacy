...
<TR>
	...
	<TR>
		<TD style class="smallTxt" align="center" width="50%"><a href="/lweb/company/staff/jobOrder.asp?who=1"><strong>Post a New Job</a></strong></TD>
...
<FORM NAME="searchJobListings" METHOD="post" ACTION="jobModList.asp?who=1">
...
%>
    				...
    				<TR> 
      					<TD colspan="2" align="center"><INPUT TYPE="button" STYLE="background:#4682b4; border:1 #000000 solid; font-size:9px; color:#FFFFFF;" NAME="submitBtn" VALUE="Start Search..." onClick="goSearch()"></TD></FORM>
    				</TR>	
  					</TABLE>
				</TD>
				</TR>
