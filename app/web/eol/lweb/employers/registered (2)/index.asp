...
<TITLE><%=session("companyName")%>:&nbsp;&nbsp;<%=session("companyAgent")%>, Welcome to Personnel Plus!</TITLE>
...
<table border="1" width="100%">
	...
	<tr>
				...
				<TR>
					<td align="left" width="368">
						<font style class="smallTxt">
							<a href="/lweb/employers/registered/editProfile.asp?who=1">Edit Account</a>
						</font>
					</td>
				</tr>											
			</table>
		...
		<td width="22%" colspan="3" align="center">Since <strong><%=FormatDateTime(rsEmployerProfile("dateCreated"),2)%></strong>, 
			...
			<li>
				<a href="/lweb/employers/registered/jobAdd.asp?who=1">Post a New Job</a>
			</li>
			<!--li-->
				<a href="/lweb/employers/registered/timecards/index.asp" target="_blank"><!--Submit Employee Time Cards-->&nbsp;</a>
			<!--/li-->
			<p>&nbsp;
