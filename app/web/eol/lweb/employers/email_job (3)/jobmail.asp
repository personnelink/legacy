...
<!-- #INCLUDE VIRTUAL='/lweb/advertise/inc/navi_top.asp' -->
...
%>
<FORM NAME="emailJobOrder" METHOD="POST" ACTION="/lweb/employers/email_job/sendjob.asp">	
			...
			<TABLE BORDER=0 width="100%" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
				<TR>
					...
					<INPUT TYPE="radio" STYLE="background:#FFFFFF; border:0; color:#FFFFFF" NAME="jobSchedule" VALUE="FP" TABINDEX="19">Both
						...
						<tr>
								<TD COLSPAN="2" ALIGN="center" STYLE CLASS="smallTxt"><IMG SRC="/lweb/img/asterisk.gif" ALT="" WIDTH="7" HEIGHT="9" BORDER="0"><STRONG><font color="#000000"> Job Description / Duties:</font></STRONG></TD>
								</tr>
						<tr>
					...
					<SELECT NAME="jobTimeBreaks" TABINDEX="23">
						...
						<OPTION VALUE="See Job Desc">* See Job Description</OPTION>		
							...
							<b>Jobsite Address (required):</b></TD>
								...
								<TR>
							<TD ALIGN="right" STYLE CLASS="smallTxt"><IMG SRC="/lweb/img/asterisk.gif" ALT="" WIDTH="7" HEIGHT="9" BORDER="0"> Address:</TD>
						...
						<SELECT NAME="jobState" TABINDEX="28">
							...
							<b>Contact Information (required):</b></TD>
								...
								<TR>
							<TD ALIGN="right" STYLE CLASS="smallTxt"><IMG SRC="/lweb/img/asterisk.gif" ALT="" WIDTH="7" HEIGHT="9" BORDER="0"> 
...
<!-- #INCLUDE VIRTUAL='/lweb/advertise/inc/navi_btm.asp' -->
</BODY>
</HTML>