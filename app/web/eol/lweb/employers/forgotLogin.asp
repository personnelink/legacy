...
<TABLE WIDTH="90%" BORDER=0 CELLPADDING=0 CELLSPACING=0 BGCOLOR="#FFFFFF">					
	<TR>
		<TD COLSPAN="2" ALIGN="center">
			...
			<TR>
				<TD BGCOLOR="#003366" ALIGN="left" HEIGHT="35"><IMG SRC="/lweb/img/tab_top_left.gif" ALT="" WIDTH="17" HEIGHT="35" BORDER="0"><IMG SRC="/lweb/img/tab_help_login.gif" ALT="Login Help" WIDTH="123" HEIGHT="31" BORDER="0" ALIGN="absmiddle"></TD>
<TD BGCOLOR="#003366" HEIGHT="35" ALIGN="right"><FONT COLOR="#FFFFFF">What is my login?</FONT><IMG SRC="/lweb/img/tab_top_right.gif" ALT="" WIDTH="17" HEIGHT="35" BORDER="0" ALIGN="absmiddle"></TD>
				</TR>
				<TR>
				<TD COLSPAN="2"><FORM NAME="forgotLogin" ACTION="/lweb/employers/sendLogin.asp" METHOD="post" onSubmit="noReturn('forgotPassword'); return false">
					<TABLE WIDTH="100%" BORDER="0" CELLSPACING="8" CELLPADDING="0" style="border: 1px solid #D1DCEB;">	

					<TR>
					<TD COLSPAN="2" ALIGN="center">
                   To recover your information and regain access to your<br> Personnel Plus Employer account, please enter your E-mail address.<P></P>
