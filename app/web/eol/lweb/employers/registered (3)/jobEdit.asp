...
<img src="/lweb/img/spacer.gif" alt="" width="1" height="19" border="0">
								...
								<tr>
									<td align="right">Job Status = <%if rsEditJob("jobStatus") = "Open" then%><img src="/lweb/img/ico_open.gif" alt="JOB IS OPEN" width="19" height="23" border="0" align="absmiddle">
<%else%>
<img src="/lweb/img/ico_close.gif" alt="JOB IS CLOSED" width="19" height="23" border="0" align="absmiddle">
<%end if%></td>
									<td bgcolor="#FFFFFF">
