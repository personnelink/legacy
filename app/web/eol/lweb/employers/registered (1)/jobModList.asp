		...
		<td align="center">
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
				...
				<TABLE width="65%" border="0" cellpadding="2" cellspacing="5" bgcolor="#FFFFFF">
					<TR>
		<TD style class="smallTxt" align="center" width="30%"><a href="/lweb/company/staff/jobMod.asp?who=1"><strong>&lt;Back to Main Search</a></strong></TD>					
		<TD style class="smallTxt" align="center" width="30%"><a href="/lweb/company/staff/jobOrder.asp?who=1"><strong>Post a New Job</a></strong></TD>
...
%>
				...
				<tr>
				 <td colspan="7" background="/lweb/img/spacer_black.gif"></td>
				</tr>
                <tr> 
				  <td style class="smallTxt" align="center"><a href="jobEdit.asp?who=1&?jobID=<%=rsSearch("jobID")%><%=srchStr%>"><strong>EDIT</strong></a></td>
                  <td style class="smallTxt" align="center"><%if rsSearch("jobStatus") = "Closed" then%><!a href="jobOpen.asp?who=1&?jobID=<%=rsSearch("jobID")%><%=srchStr%>"><img src="/lweb/img/ico_close.gif" alt="JOB IS CLOSED" width="19" height="23" border="0"></a><%else%><!a href="jobClose.asp?jobID=<%=rsSearch("jobID")%><%=srchStr%>"><img src="/lweb/img/ico_open.gif" alt="JOB IS OPEN" width="19" height="23" border="0"></a><%end if%></td>
