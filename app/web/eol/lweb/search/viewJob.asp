...
<p></p>
<STRONG><font size="3"><A HREF="/lweb/seekers/registered/index.asp?who=2&?jobID=<%=rsListings("jobID") %>&apply=1">Apply for this position</A></font></STRONG>
<% else %>
<strong>* To apply for this job you will need to login first.</strong><br> New to this site? <a href="/lweb/seekers/new/newAcct1.asp">Create your FREE account now and apply within minutes.</a>	
<br>
<% end if %>							  		
</td>
</tr>															
