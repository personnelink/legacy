...
var dispositions = {
	...
	set: function(id) {
		...
		document.getElementById("loader"+id).className = "working";
		...
		//do procedure call
		var PostStr = "";
		doAJAXCall('ajax/doThings.asp?do=change&id='+id+'&site='+site+'&disposition='+selbox.value, 'POST', '' + PostStr + '', dispositions.setidle);
	},
	hide: function(id) {
		//hide current disposition status
		document.getElementById("disposition"+id).className = "disposition";
