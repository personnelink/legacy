...
Revision 1.01 2004/11/6
Since Myrthful used horizontal bookmarks and trails, things looked odd.
Added variables $bookmarkshape and $trailshape = vertical|horizontal in skinconfig.xml
Either shape of bookmarks and trails is rendered by ow.xsl depending on the variable!

Create skin: based on Myrthful 2.1 (step 1)
Idea is to create a default skin that is layed out by css and not by tables
Took Myrthful and made a very basic css file
