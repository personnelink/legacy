...
<!--
 ...
 Revision 1.1  2004/11/07 15:12:53  gbamber
 New skin from Andy Kaplan
...
<!-- trailshape = vertical|horizontal -->
        <xsl:variable name="trailshape">horizontal</xsl:variable>
<!-- bookmarkshape = vertical|horizontal -->
        <xsl:variable name="bookmarkshape">horizontal</xsl:variable>
