...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:rss="http://purl.org/rss/1.0/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:h="http://www.w3.org/1999/xhtml" xmlns:hr="http://www.w3.org/2000/08/w3c-synd/#" xmlns:wiki="http://purl.org/rss/1.0/modules/wiki/" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:ow="http://openwiki.com/2001/OW/Wiki" extension-element-prefixes="rdf rss dc h hr wiki msxsl ow" exclude-result-prefixes="" version="1.0">
    ...
    -
    <a href="{rss:link}" class="rss" title="{rss:description}">
				<xsl:call-template name="truncatethis">
					<xsl:with-param name="thetext" select="string(rss:title)"/>
