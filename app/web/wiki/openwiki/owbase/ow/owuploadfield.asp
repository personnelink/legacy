...
'	Date:		March 19, 2002
'
'   Modified:   August 14, 2004 by Carl Leubsdorf
'               Mods for OpenWiki
'               Renamed to "UploadField"
' ------------------------------------------------------------------------------
...
'
'	objUploadField.FileDir
'		Directory that file was sent from
'
'		ie: C:\Documents and Settings\lmoten\Desktop
'
'	objUploadField.FileExt
'		Uppercase Extension of the file
'
'		ie: GIF
'
'	objUploadField.FileName
'		Name of the file
'
'		use: Response.AddHeader "Content-Disposition", "filename=""" & objUploadField.FileName & """"
'
'		ie: Photo.gif
'
'	objUploadField.ContentType
'		Type of binary data
'
'		use: Response.ContentType = objUploadField.ContentType
'
'		ie: image/gif
'
...
'
'		use: Response.Write "The value of this field is: " & objUploadField.Value
'
'	objUploadField.BinaryData
'		Contents of files binary data. (Integer SubType Array)
'
'		use: Response.BinaryWrite objUploadField.BinaryData
'
'	objUploadField.BLOB
'		Same thing as BinaryData but with a shorter name.  Added to help prevent
'		confusion with database access.
'
'		use: Call lobjRs.Fields("Image").AppendChunk(objUploadField.BLOB)
'
'	objUploadField.Length
'		byte size of Value or BinaryData - depending on type of field
'
'		use: Response.Write "The size of this file is: " & objUploadField.Length
'
'	objUploadField.BinaryAsText()
...
'
'		use: Response.Write objUploadField.BinaryAsText()
'
'	objUploadField.SaveAs()
'		Saves binary data to a specified path.  This will overwrite any existing files.
'
'		use: objUploadField.SaveAs(Server.MapPath("/Uploads/") & "\" & objUploadField.FileName)
'
' ------------------------------------------------------------------------------
Class UploadField
