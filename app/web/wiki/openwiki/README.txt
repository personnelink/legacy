...
Installation
------------
Before openwiking can run you must have the following components installed:
...
Where I work we've integrated openwiking into all our internal applications.
The applications are using very structured data, but where one can input
text one can use all the flexibility and ease of the openwiking formatting 
...
------------------------------
Users of an openwiking site can not delete pages and attachments. At best 
they can mark pages and attachments as "deprecated".
Once a page or attachment is marked as "deprecated" it is not deleted 
until the openwiking administrator (that is you) runs the script 
deprecate.asp. 
...
---------------------------
Please report installation issues at http://openwiking.com/forum
