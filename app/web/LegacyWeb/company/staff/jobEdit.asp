		...
		<TR>
			<TD COLSPAN="2" ALIGN="center">
				<TABLE width="65%" border="0" cellpadding="2" cellspacing="5">
					<TR>
		<td style class="smallTxt" align="center" width="33%"><a href="/company/staff/jobModList.asp?xCrypt=<%=srchStr%>"><strong>&lt;Back to Search Results</strong></a></td>					
		<TD style class="smallTxt" align="center" width="33%"><a href="/company/staff/jobOrder.asp"><strong>Post a New Job</a></strong></TD>
					</TR>				
				</TABLE>			
			</TD>
					</TR>	
					...
					<TR>
						<TD COLSPAN="2" ALIGN="center" bgcolor="#b22222"><STRONG><FONT COLOR="#FFFFFF" SIZE="3">Edit Job Posting - </FONT></strong>  <strong><font size="3" color="#FFFFFF"><%=user_firstname%> Administration</font></strong></TD>
					</TR>								
					<TR>
...
<img src="/img/spacer.gif" alt="" width="1" height="19" border="0">
								...
								<tr>
									<td align="center" valign="top"><%if rsEditJob("jobStatus") = "Open" then%><font color="#008000"><strong>JOB IS OPEN</strong></font> <img src="/img/ico_open.gif" alt="JOB IS OPEN" width="19" height="23" border="0" align="absmiddle">
<%else%>
<font color="#FF0000"><strong>JOB IS CLOSED</strong></font> <img src="/img/ico_close.gif" alt="JOB IS CLOSED" width="19" height="23" border="0" align="absmiddle">
<br>
