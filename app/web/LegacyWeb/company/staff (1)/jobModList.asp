		...
		<td align="center">
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
				...
				<TABLE width="65%" border="0" cellpadding="2" cellspacing="5" bgcolor="#FFFFFF">
					<TR>
		<TD style class="smallTxt" align="center" width="30%"><a href="/company/staff/jobMod.asp"><strong>&lt;Back to Search Page</a></strong></TD>					
		<TD style class="smallTxt" align="center" width="30%"><a href="/company/staff/jobOrder.asp"><strong>Post a New Job</a></strong></TD>
...
<% if rsSearch.eof = true and rsSearch.BOF = true then %>
      			<tr> 
                  <td colspan="6" align="center"><strong><font color="#b22222">Your search did not return any matches</font><p></p><a href="/company/staff/jobMod.asp">Please try a different search or simplify your criteria.</a></strong></td>
                </tr>
<% else %>
                <tr> 	
...
%>
				...
				<tr>
				 <td colspan="6" background="/img/spacer_black.gif"></td>
				</tr>
                <tr> 
...
<%end if%></td>
                  ...
                  <td style class="smallTxt"><a href="jobEdit.asp?jobID=<%=rsSearch("jobID")%><%=srchStr%>"><img src="/img/ico_edit.gif" alt="EDIT" width="15" height="15" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="jobDelete.asp?jobID=<%=rsSearch("jobID")%><%=srchStr%>"><img src="/img/ico_del.gif" alt="DELETE" width="17" height="16" border="0"></a>
</td>
                </tr>
