...
<html>
	<head>
		...
		<meta name="description" content="Personnel Plus is 'Your Total Staffing Solution'. We specialize in providing quality employees for every job.">
				...
				<td align="center">
					...
					<%if user_name <> "" then%>
						<tr>
							<td align="center" bgcolor="#eee8aa" style="border: 1px solid #eee8aa;">
								<font color="#003366">
									<strong>Welcome,  <%=user_firstname%>&nbsp;<%=user_lastname%></strong>
								</font>
							</td>
						</tr>
						<tr>
							<td align="center" height="25">
								<a href="/seekers/registered/index.asp?who=2&?#app"><strong>Go To Account</strong></a>
							</td>
						</tr>
					<%end if%>
					<%if user_name = "" then%>
						<tr>
							<td align="center" bgcolor="#C7D2E0" width="570" height="35">
								<font size="+1" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">
									<a href="/index2.asp?who=2&?#app"><span style="text-decoration: none;">Applicants!</span></a>
								</font>
								Job Seekers, see what <strong>Personnel Plus</strong> has to offer.
							</td>
							<td bgcolor="#C7D2E0" align="center" valign="middle">
								<form method="post" action="/index2.asp?who=2&?#app" style="padding: 0; margin: 0;">
						...
						<tr>
							<td colspan="2" style="border: 1px solid #C7D2E0;" height="103" width="568" align="center">
								<a href="/seekers/new/applyDirect.asp?who=2" style="text-decoration: none; font-weight: bold; color: #BD1429">You Can Try Your Job First!!!</a>
								<br />
								...
								<br />
								<a href="/index2.asp?who=2&?#applicant" style="color: #BD1429; font-weight: bold; text-decoration: none">Click here for more Information</a>
							</td>
						</tr>
					<%end if%>
						<tr>
						...
						<tr>
							<td style="border: 1px solid #C7D2E0;" height="103" width="568" colspan="2" align="center">
								...
								<br /><a href="/orientation/rules.asp" target="_blank">Rules to Remember</a>
								<br /><a href="/orientation/rights.asp" target="_blank">Your Right to Know</a>
								<br />
								<% if request.cookies("OSHATEST") <> "DONE" then %>
									<a href="/orientation/company/OSHA/OSHA.asp" target="_blank">OSHA</a>
								<% else %>
					...
					<%if session("companyUserName") <> "" then%>
						<tr>
							...
							<td width="100">
								<a href="/employers/registered/index.asp?who=1&?#applicant" style="font-weight: bold;">Go To Account</a>
							</td>
					...
					<%if session("companyUserName") = "" then %>
						<tr>
							<td align="center" bgcolor="#C7D2E0" width="564" height="35" valign="top" colspan="2">
								<font size="+1" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><a href="/index2.asp?who=1&?#applicant" style="text-decoration:none;">Employers!</a></font> We have Quality Employees.
							</td>
							<td bgcolor="#C7D2E0" align="center" valign="middle">
								<form method="post" action="/index2.asp?who=1&?#applicant" style="padding: 0; margin: 0;">
						...
						<tr>
							<td style="border: 1px solid #C7D2E0; text-align:center;" height="103" width="560" colspan="3">
								<a href="/company/benefits.asp" target="_blank" style="text-decoration: none; color: #BD1429; font-weight: bold;">Screened and Ready to Work!</a>
								<br /><br />
								...
								* Call Center * Office / Clerical * Bookkeeping * Janitorial *
								...
								<br /><br />
								<a href="/company/post.asp" style="text-decoration: none; color: #bd1429; font-weight: bold;" target="_blank">Click here for more Information</a>
							</td>
						</tr>
					<%end if%>
					</table>
					<!-- Final Stuff -->
					<p><img src="/img/shake.jpg" alt="" width="150" height="85" border="0" align="left" hspace="0"></p>
					...
					<p><a href="http://www.staffingtoday.net/aboutasa/index.html" target="_blank"><img src="/img/asa.gif" alt="" width="264" height="48" border="0"></a>
				</td>
			</tr>
		</table>
	</div>
