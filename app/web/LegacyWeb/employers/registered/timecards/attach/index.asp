...
<TABLE WIDTH=750 BORDER=0 CELLPADDING=0 CELLSPACING=0 bgcolor="#dcbace">
    <FORM ENCTYPE="multipart/form-data" METHOD=post id=form1 name=form1 action="/employers/registered/timecards/attach/index.asp?func=2"> 
		<tr>
...
msgBody = "<!DOCTYPE HTML PUBLIC ""-//W3C//DTD HTML 4.0 Transitional//EN"">" & vbCrLf _
		& "<html>" & vbCrLf _
		& "<head>" & vbCrLf _
		& " <title>Timecard Submittal from " & company_name & "</title>" & vbCrLf _
		& " <meta http-equiv=Content-Type content=""text/html; charset=iso-8859-1"">" & vbCrLf _
		& "</head>" & vbCrLf _
		& "<body bgcolor=""#FFFF99"">" & vbCrLf _
		& " <h2>Timecard Submittal from " & company_name & " at " & request.cookies("timecard")("time") & "</h2>" & vbCrLf _
		& " <p>" & vbCrLf _
...
'	  .To = "saguilar@personnel.com"
      ...
      .Subject = "Personnel Plus - Timecard Submittal from " & company_name
'      .Send 
End With 
