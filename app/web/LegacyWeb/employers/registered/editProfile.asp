...
<TITLE>Edit Employer Account : <%=company_name%>&nbsp;-&nbsp;<%=session("companyAgent")%></TITLE>
...
<TABLE width="75%" BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#ffffff">
	<TR>
		<TD align="center" valign="top" bgcolor="#9acd32"><strong>Edit Account - <%=company_name%></strong></td>
	</tr>
	<tr>
		<td valign="top" align="center" STYLE="border: 1px solid #999999;">
		<form name="frmEditProfile" method="post" action="/employers/registered/editProfile2.asp?who=1">
			<table>
				<tr>
...
<input type="radio" style="background:#FFFFFF; border:0; color:#FFFFFF"name="companyType" value="Individual" <% if rsfrmEditProfile("companyType") = "Individual" then%>CHECKED<%end if%>>Individual</td>
	...
	<SELECT NAME="country">
		...
		<% loop %>	
				...
				<tr>
					<td colspan="2"><img src="/img/spacer.gif" alt="" width="1" height="6" border="0"></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="left" colspan="2">[<a href="/employers/registered/index.asp?who=1"><font style class="smallTxt">Cancel &amp; Return To Control Panel</font></a>]</td>
				</tr>																																														
