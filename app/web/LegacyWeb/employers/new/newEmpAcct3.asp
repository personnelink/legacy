...
<TABLE WIDTH="75%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
				<TR>
				<TD BGCOLOR="#003366" ALIGN="left" HEIGHT="35"><IMG SRC="/img/tab_top_left.gif" ALT="" WIDTH="17" HEIGHT="35" BORDER="0"><IMG SRC="/img/tab_emp_profile.gif" ALT="Personal Profile" WIDTH="166" HEIGHT="31" BORDER="0" ALIGN="absmiddle"></TD>
<TD BGCOLOR="#003366" HEIGHT="35" ALIGN="right" NOWRAP><FONT COLOR="#FFFFFF">Creating Your New Employer Account - STEP 2 of 3</FONT><IMG SRC="/img/tab_top_right.gif" ALT="" WIDTH="17" HEIGHT="35" BORDER="0" ALIGN="absmiddle"></TD>
				</TR>
					  <tr>
					...
					<TABLE WIDTH="100%" BORDER="0" CELLSPACING="10" CELLPADDING="0" style="border: 1px solid #D1DCEB;">
	                      ...
	                      <tr> 
	                        <td align="right" width="50%"><IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9> Company Name:</td>
	                        <td> 
	                          <input type="text" name="companyName" size="35" maxlength="100">
	                        </td>
						  </tr>
						  <tr>
	                        <td align="right"><IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9> Your First Name:</td>
	                        <td> 
	                          <input type="text" name="companyAgentFirstName" size="25" maxlength="30">
	                        </td>
	                      </tr>
						  <tr>
	                        <td align="right"><IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9> Your Last name:</td>
	                        <td> 
							  <input type="text" name="companyAgentLastName" size="25" maxlength="40">
	                        </td>
	                      </tr>					  
						  <tr>
	                        <td align="right"><IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9> Your Job Title/Position:</td>
	                        <td><input type="text" name="companyAgentTitle" size="30" maxlength="100">
	                        </td>
	                      </tr>					  
	                      <tr> 
	                        <td align="right"><IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9> Company Address:</td>
	                        <td>
						  ...
						  <tr>
	                        <td valign="top" align="right"><IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9> City:</td>
	                        </td>
	                        <td valign="top">
	                      ...
	                      <tr> 
	                        <td valign="top" align="right"><IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9> State/Province:</td>
	                        <td> 
							<select name="state">
	...
	%>
	                      ...
	                      <tr> 
	                        <td align="right"><IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9> Zip/Postal Code:</td>
	                        <td> 
	                          <input type="text" name="zipCode" size="10" maxlength="8"> - <input type="text" name="zipCodePlus4" size="4" maxlength="4">
	                        </td>
						  </tr>
	                      <tr> 
	                        <td valign="top" align="right"><IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9>  Country:</td>
	                        <td> 
	<SELECT NAME="country" TABINDEX="10">
		...
		<% loop %>	
						  ...
						  <tr>
	                        <td align="right"><IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9> E-mail address:<br>
						  ...
						  <tr>
	                        <td align="right"><IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9> Job E-mail address:<br>
						  ...
						  <tr>
	                        <td align="right"><IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9> Contact/Message Phone #:</td>
	                        <td> 
