		...
		<tr>
			<td align="center">
				...
				<% if user_firstname <> "" then %>
					Welcome <%=user_lastname %>, <%=user_firstname %>,<br><br>
					Please verify your email address below.<br><br>
				<% end if %>
		...
		<tr>
			<td align="center">
					<% if session("emailAddress") <> "" then %>
						<input type="hidden" name="submit_fname" value="<%=user_firstname %>">
						<input type="hidden" name="submit_lname" value="<%=user_lastname %>">
