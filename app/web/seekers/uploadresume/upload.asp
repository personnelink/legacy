...
<title><%=user_lastname%>, <%=user_firstname%>  - Upload an Existing 
...
<FORM METHOD="POST" ENCTYPE="multipart/form-data" ACTION="upload2.asp">
 <TABLE BORDER=0>
 <tr><td><b>Enter your fullname:</b><br><INPUT TYPE=TEXT SIZE=40 NAME="FULLNAME" value="<%=user_lastname%>, <%=user_firstname%>"></td></tr>
