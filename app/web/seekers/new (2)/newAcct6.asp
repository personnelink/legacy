...
user_firstname = rsuser_firstname
user_lastname = rsuser_lastname
user_name = rsuser_name
...
if rememberLogin = "Yes" then
		...
		response.cookies("seeker") ("userName") = user_name
...
msgBody = msgBody & "User Name:" & user_name & chr(13)
...
'Mail.Subject = "Welcome to Personnel Plus, " & user_firstname & "!"
'Mail.Body = msgBody
'Mail.Send
'Set Mail = Nothing
%>
...
response.redirect("/seekers/registered/applyOnline.asp?who=2")
%>
