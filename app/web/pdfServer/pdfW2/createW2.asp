...
dim which_year
which_year = request.QueryString("year")
if len(which_year) > 0 then
	dim this_year
	select case which_year
	case "2009"
		this_year = "2009"
	case "2010"
		this_year = "2010"
...
dim which_applicant : which_applicant = request.QueryString("id")
if len(which_applicant) > 0 then
	dim this_applicant
	this_applicant = cdbl(which_applicant)
end if

dim forWhatBranch, branchEmail, tempsApplicantId

tempsApplicantId = "n/a"

dim which_site, qsBuffer
qsBuffer = request.querystring("site")
if len(qsBuffer) > 0 then
	if isnumeric(qsBuffer) then
		which_site = cint(qsBuffer)
	else
		which_site = getTempsDSN(qsBuffer)
	end if

	dim this_site
	select case cint(which_site)
	case PER, "per"
		this_site = "PER"
		tempsApplicantId = "PER:" & this_applicant
		forWhatBranch = " Twin Falls"
		branchEmail = "twin@personnel.com"
		
	case BUR, "bur"
		this_site = "BUR"
		tempsApplicantId = "BUR:" & this_applicant
		forWhatBranch = " Burley"
		branchEmail = "burley@personnel.com"

	case IDA
		this_site = "IDA"
		tempsApplicantId = "IDA:" & this_applicant
		forWhatBranch = "n Idaho Department of Agriculture"
		branchEmail = "everybody@personnel.com"
		
	case BOI
		this_site = "BOI"
		tempsApplicantId = "BOI:" & this_applicant
		forWhatBranch = " Boise / Nampa"
		branchEmail = "boise@personnel.com;nampa@personnel.com"
		
	case PPI
		this_site = "PPI"
		tempsApplicantId = "PPI:" & this_applicant
		forWhatBranch = " PPI - Boise / Nampa"
		branchEmail = "boise@personnel.com;nampa@personnel.com;burley@personnel.com"

	case TWI
		this_site = "TWI"
		forWhatBranch = " Twin Falls Internal"
		branchEmail = "debug@personnel.com"
		
	case BSE
		this_site = "BSE"
		forWhatBranch = " Boise Internal"
		branchEmail = "debug@personnel.com"

	case BLY
		this_site = "BLY"
 		forWhatBranch = "Burley Internal"
		branchEmail = "debug@personnel.com"
   case ORE
		this_site = "ORE"
		tempsApplicantId = "ORE:" & this_applicant
		forWhatBranch = " Oregon"
		branchEmail = "burley@personnel.com"

    case WYO
		this_site = "WYO"
		tempsApplicantId = "WYO:" & this_applicant
		forWhatBranch = " Wyoming"
		branchEmail = "burley@personnel.com"
...
if debug_mode then print "id=" & this_applicant & " : site=" & this_site & " : year=" & this_year

if request.QueryString("action") = "agreeanddownload" then
