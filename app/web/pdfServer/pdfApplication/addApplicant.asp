...
<form method="post" action="<%=PostTo%>">
    <div class="sideMargin border" style="margin-left: 0">
        <div>
            ...
            <div class="divided">
                <p style="text-align: center">
                    <img src="/include/style/images/createUser.jpg" style="padding-left: 15px; padding-bottom: 15px;"></p>
            </div>
        ...
        <div>
            <div class="normalTitle" style="margin-bottom: 10px;">Profile Information</div>
            <div class="divided center" style="padding-left: 90px">
                <p>
        ...
        <div>
            <div class="normalTitle" style="margin-bottom: 10px;">Contact Information</div>
            <div class="divided center" style="padding-left: 90px">
                <p>
...
<div class="mainPage center">
    <div id="signIn" style="width: 400px; margin-top: 50px; margin-bottom: 50px;">
        <div class="normalTitle">User Account Created</div>
        <div style="width: 20%; border: none; margin-top: 5px; float: left;">
            <img src="/include/style/images/createUser.jpg" style="padding: 15px; padding-top: 0;">
        </div>
        <div style="width: 70%; border: none; margin-top: 0; float: right; padding: 10px;">
        ...
        <div style="width: 100%; border-top: 1px solid #97A4B3; padding-top: 10px;">
