...
<!-- #INCLUDE VIRTUAL='/js/autototal.js' -->
...
<form name="TimeSheet" action="/employers/registered/timecards/form/emailtime.asp" method="post">
<table border="0" width="84%" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td colspan="3">
		<p align="center">Company:&nbsp;<input type="text" name="company" size="82" value="<%=company_name%>" tabindex="1"></td>
	</tr>
	<tr>
		<td width="28%">
