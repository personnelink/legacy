...
<TD BGCOLOR="#003366" HEIGHT="35" ALIGN="right" NOWRAP><FONT COLOR="#FFFFFF">Creating Your New Employer Account - STEP <STRONG>1</STRONG> of 3</FONT><IMG SRC="/img/tab_top_right.gif" ALT="" WIDTH="17" HEIGHT="35" BORDER="0" ALIGN="absmiddle"></TD>
				</TR>
				<TR>
				<TD COLSPAN="2">
...
<% end if %>					
					...
					<TR>
					<TD><IMG SRC="/img/spacer.gif" WIDTH="16" HEIGHT="1" BORDER="0">
					<IMG SRC="/img/asterisk.gif" WIDTH=7 HEIGHT=9> Business Type:<br>
<IMG SRC="/img/spacer.gif" WIDTH="28" HEIGHT="1" BORDER="0"><input type="radio" style="background:#FFFFFF; border:0; color:#FFFFFF" name="companyType" value="Corporate">Corporation&nbsp;&nbsp;
