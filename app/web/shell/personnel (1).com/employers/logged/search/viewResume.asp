...
rsViewRes.Open "SELECT * FROM tbl_resumes WHERE res_id = " & request("id") & " AND res_is_active = 1",Connect
              ...
              <tr> 
                <td> 
                  <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><a href="index.asp"><img src="/images/headers/resumeSearch.gif" width="328" height="48" border="0"></a></td>
                      <td>&nbsp;</td>
                    </tr>
                          ...
                          <tr> 
                            ...
                            <td colspan="3"> 
                              <table border="0" cellspacing="3" cellpadding="0" width="100%">	
                                <tr> 
                                  <td width="20%" nowrap class="middleMenu"><strong>Candidate Name:</strong></td>
                                  <td width="80%" class="resTitle"><%=rsViewRes("res_first_name")%>&nbsp;<%=rsViewRes("res_last_name")%></td>
                                </tr>							  					
                                <tr> 
                                  <td width="20%" nowrap class="middleMenu"><strong>Resume Title:</strong></td>
                                ...
                                <tr> 
                                  <td width="20%" class="middleMenu"><strong>Options:</strong></td>
                                  <td width="80%" class="sideLinks"><a href="mailto:<%=rsViewRes("res_email_address")%>"><img src="/images/mail.gif" alt="" width="18" height="18" border="0" align="absmiddle"></a> <a href="mailto:<%=rsViewRes("res_email_address")%>">Email Candidate</A>
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="0">
<!--					<tr>
						<td colspan="2" align="right"><img src="/images/ico_print.gif" alt="Printer-friendly View" width="18" height="15" border="0" align="bottom"> <font size="1">Print</font></td>
					</tr>		
-->								
					<tr>
                      <td width="30"><img src="/images/pixel.gif" width="30" height="1"></td>
...
<% if rsViewRes("res_college_name1") <> "" then %>								  
<tr>
...
<% if rsViewRes("res_college_name2") <> "" then %>	
<tr>
