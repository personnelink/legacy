...
rsMsgs.Open "SELECT msg_id, emp_id, msg_is_read, msg_from, msg_subject, msg_date_created FROM tbl_employer_messages WHERE emp_id = " & session("empID") & " ORDER BY msg_date_created DESC",Connect
%>

<html>
<head>
<title>Employer Message Center - www.personnel.com</title>
