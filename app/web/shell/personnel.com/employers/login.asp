...
'	*************************  File Description  *************************
'		FileName:		login.asp
'		Description:	Employer login page
'						Sends username and password to setSession.asp
'		Created:		Tuesday, March 2, 2004
...
<html>
<head>
<title>Employer Login - www.personnel.com</title>
              ...
              <tr> 
                <td> 
                  <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><img src="/images/headers/employerLogin.gif" width="328" height="48"></td>
                    </tr>
                    <tr> 
                      <td> 
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <form name="loginInfo" method="post" action="setSession.asp">
                                <table width="90%" border="0" cellspacing="0" cellpadding="5" bgcolor="#ffffff">
                                  <tr> 
                                    <td colspan="3" class="redHead">
                                      <p class="smallDesc">
                                        ...
                                        <strong><img src="/images/ico_alert.gif" alt="" width="25" height="19" border="0" align="absmiddle"> <font color="#b22222">Invalid login information, please try again.</font></strong> 
                                  ...
                                  <tr> 
                                    ...
                                    <td width="82%"> 
                                      <input type="text" name="emailAddress" size="26" maxlength="50" onBlur="IsEmail(this);">
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td width="30"><img src="/images/pixel.gif" width="25" height="2"></td>
                                  ...
                                  <tr> 
                                    ...
                                    <td width="82%" class="sideMenu"><strong><a href="forgot.asp"><font size="2">Forgot your Password?</font></a></strong><br>
                                      <a href="mailto:webmaster@personnel.com?Subject=Employer%20Account%20--%20Problems%20Signing%20In&body=Please%20describe%20your%20problem%20here."><font size="1">Still Having Trouble? </font></a></td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3"><br>
                                    </td>
...
<br>
Register to access the employer Hiring Management System. 
With powerful online tools you can fill a position quickly and easily 
with one of the many qualified Job Seekers.
                                            </td>
                                          <td> 
                                        </tr>
                                      </table>
