...
<% if request("test") = "2" then %>
	<div style="position: absolute; width: 100px; height: 30px; z-index: 3; left: 357px; top: 123px" id="test">
		<FORM method="post" action="/orientation/company/OSHA/tests/officetest.asp?goback=3"> 
...
<% if request("test") = "3" then %>
	<div style="position: absolute; width: 100px; height: 30px; z-index: 3; left: 357px; top: 123px" id="test">
		<FORM method="post" action="/orientation/company/OSHA/tests/labortest.asp?goback=3"> 
...
<TABLE WIDTH="800" BORDER="0" CELLPADDING="0" CELLSPACING="0">
	...
	<TR>
		...
		<TD COLSPAN="1"><a href="/index.asp"><IMG SRC="/img/navi-2.gif" WIDTH="283" HEIGHT="72" border="0" alt="Personnel Plus, Inc."></A></TD>	
...
<!-- END PLACE ADD -->
	...
	<TR>
		<TD ROWSPAN="1"><IMG SRC="/img/navi-12.gif" WIDTH="283" HEIGHT="8" border="0"></TD>
		<td rowspan="1"><img src="/img/navi-12.gif" width="281" height="8" border="0"></td>
