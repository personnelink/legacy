...
<script type="text/javascript" src="timecards.003.js"></script>
...
<div id="whoseHereList"><%	if userLevelRequired(userLevelPPlusStaff) AND perspective <> "customer" then %>
	...
	<a href="/include/system/tools/activity/reports/Time_Archive/" style="margin:0 0 0.4em;display:block;float:right;">[ time archive report ]</a>
...
<a href="/include/system/tools/activity/reports/Time_Archive/" style="display:block;margin-top:0.4em;">[ time archive report ]</a>
<%=PageNavigation%>
</div>
